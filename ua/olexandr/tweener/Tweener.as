package ua.olexandr.tweener {
	...
	public class Tweener {
		...
		public static function addTween (p_scopes:Object, p_time:Number = 0, p_parameters:Object = null):Boolean {
			...
			if (!_inited) init();
			if (!_engineExists || !Boolean(_controller)) startEngine(); // Quick fix for Flash not resetting the vars on double ctrl+enter...
        ...
        */
		...
		public static function getVersion():String {
			return "AS3 1.00 (caurina v.1.33.74)";
		}
