package ua.olexandr.geo.db {
	import ua.olexandr.data.TSVParser;
	import ua.olexandr.geo.Continent;
	import ua.olexandr.geo.Country;
	import ua.olexandr.geo.MapCoordinate;
	import ua.olexandr.utils.GeoUtils;
				...
				for each (var s:String in c) {
					...
					for each (var p:String in ms) {
						...
						if (lstPos == null) {
							...
							} else if (GeoUtils.distance(lstPos, newPos) > res || newPos.lat < -75) {
