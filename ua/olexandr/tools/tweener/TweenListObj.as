package ua.olexandr.tools.tweener {
	...
	public class TweenListObj {
		...
		public var ease						:Function;	// Equation to control the ease animation
		public var easeParams				:Object;	// Additional parameters for the ease
		 ...
		 * @param	p_ease				Function	Equation to control the ease animation
		 */
		function TweenListObj(p_scope:Object, p_timeStart:Number, p_timeComplete:Number, p_useFrames:Boolean, p_ease:Function, p_easeParams:Object) {
			scope				=	p_scope;
		...
		public function toString():String {
			...
			returnStr += ", ease:" + String(ease);
			returnStr += ", easeParams:" + String(easeParams);
